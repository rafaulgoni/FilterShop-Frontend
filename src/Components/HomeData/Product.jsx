...
const Product = () => {
    ...
    useEffect(() => {
        fetch(`https://filter-shop-backend.vercel.app/productRange?range=${range}`)
            .then(res => res.json())
            .then(data => {
                setProducts(data)
            })
    ...
    useEffect(() => {
        fetch(`https://filter-shop-backend.vercel.app/productBrand?brand=${brand}`)
            .then(res => res.json())
            .then(data => {
                setProducts(data)
            })
    ...
    useEffect(() => {
        fetch(`https://filter-shop-backend.vercel.app/productCategory?category=${category}`)
            .then(res => res.json())
            .then(data => {
                setProducts(data)
            })
    ...
    useEffect(() => {
        fetch(`https://filter-shop-backend.vercel.app/productFind?name=${search}`)
            .then(res => res.json())
            .then(data => {
                setProducts(data)
            })
    ...
    useEffect(() => {
        fetch('https://filter-shop-backend.vercel.app/productsCount')
            .then(res => res.json())
            .then(data => setCount(data.count))
    }, [])

    useEffect(() => {
        fetch(`https://filter-shop-backend.vercel.app/products?page=${currentPage}&size=${itemsPerPage}`)
            .then(res => res.json())
