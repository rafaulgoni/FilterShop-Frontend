            ...
            <footer className="px-4 divide-y bg-base-200">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <img className=" w-60" src={"https://i.ibb.co/KNyd47D/aaa-removebg-preview.png"} alt="" />
                    </div>
                ...
                <div className="py-6 text-sm text-center dark:text-gray-600 font-bold">© 1968 Company Co. All rights reserved.</div>
            </footer>
        </div>
    );
};
